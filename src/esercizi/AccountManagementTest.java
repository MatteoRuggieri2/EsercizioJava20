...
class AccountManagementTest {
	...
	@Test
	void testFirstUsers() {
		User[] expectedUsers = { user1, user5 };
		assertArrayEquals(expectedUsers, am.firstUsers(2));
	}
	
	@Test
	void testLastUsers() {
		User[] expectedUsers = { user4, user2 };
		assertArrayEquals(expectedUsers, am.lastUsers(2));
	}
